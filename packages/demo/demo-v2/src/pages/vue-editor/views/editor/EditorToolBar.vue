                    ...
                    <div :class="$style.box">
                        <div class="switchEditor">
                            ...
                            <svg
                                ...
                                aria-hidden="true"
                            >
                                <use xlink:href="#icon-gongwenbao" />
                            </svg>
                        </div>
                        <div
                                ...
                                <div class="manager-wrap">
                                    ...
                                    >
                                        ...
                                        <span
                                            ...
                                            style="bottom: 10px;"
                                        >
                                            <span class="corner-sign-core"></span>
                                        </span>
                                    </a>
                                </div>
                                <draggable
                                ...
                                {{ currentUseComponentNum[item.componentPack.componentViewName] || 0 }} / {{ item.maxNum }}
                                            ...
                                            <div class="panel">
                                                <div class="manager__map-title">
                                                    ...
                                                    ></i><span
                                                        value="SHOW_ALL"
                                                        class="next-select medium panel-select"
                                                        tabindex="0"
                                                    ><input
                                                        type="hidden"
                                                        name="select-faker"
                                                        value="SHOW_ALL"
                                                    ><span class="next-select-inner">全部模块</span><i
                                                        class="next-icon next-icon-arrow-down next-icon-small next-select-arrow"
                                                    ></i></span>
                                                </div>
